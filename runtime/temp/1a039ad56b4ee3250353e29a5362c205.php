<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./application/admin/view/top\index.html";i:1527045017;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" abbr="article_time" axis="col6" class="">
							<div style="text-align: left; width: 240px;" class="">页面图片</div>
						</th>
						<th align="left" abbr="ac_id" axis="col4" class="">
							<div style="text-align: left; width: 250px;" class="">文字内容介绍</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 240px;"><a href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo[item_id]]); ?>">TITLE</a></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 240px;">NAME</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 50px;">NUM</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 50px;">PRICE</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;">TIME</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;">TIME</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 50px;">BUY NUM</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 50px;">ORDER NUM</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 50px;">DESC</div>
							</td>
