<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/wechat\auto_replies.html";i:1524739748;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <ul class="tab-base nc-row">
                <?php if(is_array($types) || $types instanceof \think\Collection || $types instanceof \think\Paginator): if( count($types)==0 ) : echo "" ;else: foreach($types as $k=>$v): ?>
                    <li><a href="<?php echo $v['url']; ?>"
                        <?php if($k==$type): ?>class="current"<?php endif; ?>
                        >
                        ...
                        <tr>
                            ...
                            <td align="left" axis="col6" class="">
                                <div style="text-align: center; width: 200px;" class="opt">
                                    <?php echo $list['msg_type']=='text'?$list['data']:''; ?>
                                </div>
                            </td>
                            <td align="left" axis="col6" class="">
                                <div style="text-align: center; width: 160px;" class="">
                                    <a class="btn green"
                                       href="<?php echo U('auto_reply_edit', ['id' => $list['id'], 'type' => 'keyword']); ?>">
...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm("确定删除吗？", function () {
            $.ajax({
                url: "<?php echo url('delete_auto_reply'); ?>",
                data: {id: id},
                type: 'POST',
                dataType: 'json',
