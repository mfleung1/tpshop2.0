<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view/promotion\prom_goods_list.html";i:1524739748;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									...
									<a class="btn red  del" data-id="<?php echo $vo['id']; ?>"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
...
<script>
    ...
    $(document).on('click','.del',function () {
        $.ajax({
            url:"<?php echo U('Promotion/prom_goods_del'); ?>",
