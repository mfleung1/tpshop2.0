<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/goods\_spec.html";i:1524739748;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
	   ...
	   <dl class="row" style="display:none;">
		...
		<dl class="row">
        <dt class="tit">
          <label for="ac_sort"><em>*</em>规格项：</label>
        </dt>
        <dd class="opt">
