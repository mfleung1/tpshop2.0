<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view/promotion\prom_order_info.html";i:1524739748;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="promotion"  method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row" id="expression_dl">
                ...
                <dd class="opt">
                    <input type="text" id="expression" name="expression"  value="<?php echo $info['expression']; ?>" class="input-txt">
