<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view/promotion\prom_goods_info.html";i:1524739748;s:71:"D:\phpStudy\PHPTutorial\wwwb2\application\admin\view\public\layout.html";i:1524739748;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="handleposition" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row" id="buy_limit">
                ...
                <dd class="opt">
                    <input name="buy_limit" value="<?php echo $info['buy_limit']; ?>" type="text" class="input-txt" onkeyup="this.value=this.value.replace(/[^\d]/g,'')"/>
...
<script type="text/javascript">
    ...
    function selectGoods(){
        var url = "<?php echo U('Promotion/search_goods',array('prom_type'=>3,'prom_id'=>$info[id])); ?>";
        layer.open({
            type: 2,
            title: '选择商品',
            shadeClose: true,
